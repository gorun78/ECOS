/**
 * UserEditModal — 用户编辑弹窗 (三Tab: 基本信息 / 角色绑定 / 安全Profile)
 * @license Apache-2.0
 */
...
import {
  ...
  Lock, Unlock, LogOut, Copy, Eye, EyeOff,
} from "lucide-react";
import { useLanguage } from "@/src/components/LanguageContext";
import { useTheme } from "@/src/components/ThemeContext";
import { fetchUserRoles } from "@/src/api";
import type { IamUser, IamRole, IamOrg } from "@/src/api";
