      ...
      <div className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col justify-between shrink-0">
        <div className="p-4 space-y-5">
          <div className="flex items-center gap-2.5 px-2">
            ...
            <div>
              <div className="text-xs font-black tracking-wider text-slate-200 uppercase">Foundry 安全中心</div>
          ...
          <nav className="space-y-1">
            ...
            >
              <LucideIcon name="Shield" size={13} className={activeTab === 'overview' ? 'text-indigo-400' : 'text-slate-500'} />
              <span>安全合规概览</span>
            </button>
            ...
            >
              <LucideIcon name="Globe" size={13} className={activeTab === 'orgs' ? 'text-indigo-400' : 'text-slate-500'} />
            ...
            >
              <LucideIcon name="FolderGit" size={13} className={activeTab === 'dac' ? 'text-indigo-400' : 'text-slate-500'} />
            ...
            >
              <LucideIcon name="Tag" size={13} className={activeTab === 'mac' ? 'text-indigo-400' : 'text-slate-500'} />
            ...
            >
              <LucideIcon name="ClipboardList" size={13} className={activeTab === 'pbac' ? 'text-indigo-400' : 'text-slate-500'} />
            ...
            >
              <LucideIcon name="EyeOff" size={13} className={activeTab === 'row_col' ? 'text-indigo-400' : 'text-slate-500'} />
              <span>行列级安全策略</span>
            </button>
            ...
            >
              <LucideIcon name="Activity" size={13} className={activeTab === 'audit' ? 'text-indigo-400' : 'text-slate-500'} />
            ...
            >
              <LucideIcon name="BookOpen" size={13} className={activeTab === 'guide' ? 'text-indigo-400' : 'text-slate-500'} />
              <span>管理员操作手册</span>
            </button>
          </nav>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-slate-900">
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 lg:col-span-2 space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                      <LucideIcon name="TrendingUp" size={13} className="text-indigo-400" />
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 space-y-4 flex flex-col justify-between">
                  <div className="space-y-1">
                    <div className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                      <LucideIcon name="PieChart" size={13} className="text-indigo-400" />
              ...
              <div className="bg-slate-950 border-2 border-indigo-900/40 rounded-xl p-5 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="space-y-0.5">
                    <span className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                      <LucideIcon name="Zap" size={14} className="text-indigo-400 animate-pulse" />
                      零信任策略仿真演算器 (Zero-Trust Security Policy Simulator)
                    </span>
                    <p className="text-[10px] text-slate-500">模拟不同用户、敏感资产和具体分析目的在 Foundry 级联策略链条中的真实决策判定结果</p>
                  </div>
                  <button
                  ...
                  <div className="md:col-span-2 bg-slate-900/80 p-3.5 rounded-lg border border-slate-800 flex flex-col justify-between">
                    {simResult ? (
                      ...
                      <div className="flex-1 flex flex-col items-center justify-center text-slate-500 space-y-2 py-6">
                        <LucideIcon name="ShieldAlert" size={24} className="text-slate-600" />
          ...
          {activeTab === 'orgs' && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-black text-slate-100">Foundry 组织边界配置 (Organizations Setup)</h3>
                  <p className="text-[10px] text-slate-400">Foundry 最高级别安全隔离机制。即使授予了文件权限，非共享协议白名单下的跨组织访问也将被绝对硬隔离阻断。</p>
                </div>
                <button
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-0.5">
                        <div className="text-xs font-extrabold text-slate-100 flex items-center gap-1.5">
                          <LucideIcon name="Globe" size={13} className="text-indigo-400" />
                          <span>{org.name}</span>
                        </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="text-xs font-bold text-slate-300 flex items-center gap-1">
                          <LucideIcon name="ShieldAlert" size={13} className="text-indigo-400" />
                      ...
                      <div className="bg-slate-900/40 border border-slate-800 rounded-lg p-4 space-y-4">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4 bg-slate-950/80 rounded border border-slate-800 relative">
                          ...
                          <div className="flex-1 text-center p-3 rounded bg-slate-900 border-2 border-slate-800 relative z-10 flex flex-col items-center gap-1">
                            <LucideIcon name="Database" size={16} className="text-slate-400" />
                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                          <LucideIcon name="EyeOff" size={13} className="text-indigo-400" />
                      ...
                      <div className="space-y-3">
                        <div className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                          <LucideIcon name="Filter" size={13} className="text-indigo-400" />
              ...
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div className="space-y-1">
                  <h3 className="text-sm font-black text-slate-100 flex items-center gap-2">
                    <LucideIcon name="Activity" size={15} className="text-indigo-400" />
          ...
          {activeTab === 'guide' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div className="space-y-1">
                  <h3 className="text-sm font-black text-slate-100 flex items-center gap-2">
                    <LucideIcon name="BookOpen" size={15} className="text-indigo-400" />
                ...
                {guideSection === 'arch' && (
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 border-b border-slate-800 pb-2">
                      ...
                      <h4 className="text-xs font-black text-slate-200 uppercase tracking-wider">Foundry 四层深度防御物理/逻辑校验链路</h4>
                    </div>
                  ...
                  if (line.startsWith('### ')) {
                    return (
                      <h6 key={idx} className="text-indigo-400 font-black text-xs pt-2 flex items-center gap-1.5">
                        <LucideIcon name="ShieldAlert" size={12} className="text-indigo-400" />
                        {line.replace('### ', '')}
                      </h6>
                    );
                  }
