...
function RcaResultView({
  ...
  if (!rcaResult) {
    return (
      <div className={`mt-3 text-[10px] font-mono opacity-40 px-1 py-2 rounded-md ${styles.appBg}`}>
                ...
                <React.Fragment key={o.id}>
                  <div
                    className={`flex items-center gap-3 px-4 py-3 border-b ${styles.cardBorder} ${
                      expanded ? `${styles.appBg}` : `hover:${styles.sidebarBg}`
                    } transition`}
                  >
                    {/* severity 徽章 */}
                    <button
                  ...
                  {/* 展开详情 */}
                  {expanded && (
                    <div className={`px-5 py-3 ${styles.appBg} border-b ${styles.cardBorder} space-y-2`}>
                  ...
                  {/* 指派弹层 */}
                  {assignTarget === o.id && (
                    <div className={`px-5 py-3 bg-blue-50/40 border-b ${styles.cardBorder} flex items-center gap-2`}>
