...
/**
 * com.chinacreator.warn.server.tddxmonitorwarncontact.service.
 * IMonitorWarnContactService
 * <p>
 ...
 * 
 */
public interface IMonitorWarnContactService {
	 ...
	 * @param condition
	 *            condition 闁哄被鍎撮妤呭级閳ュ弶顐?
	 * @return LegacyListInfo 闁告帒妫濋妴澶嬬┍閳╁啩绱栭悗鐢殿攰閽?
	 * @throws Exception
	 * @generated
	 */
	public PageInfo<MonitorWarnContact> findByPage(Integer offset, Integer pageSize,
