package com.chinacreator.gzcm.runtime.access.util.logging.impl;
...
import com.chinacreator.gzcm.runtime.access.util.logging.datachange.DataChangeLogEntry;
import com.chinacreator.gzcm.runtime.access.util.logging.datachange.IDataChangeLogService;
import com.chinacreator.gzcm.runtime.access.util.logging.plugin.ILoggingPlugin;
import com.chinacreator.gzcm.runtime.access.util.logging.plugin.IModuleLogHandler;
import com.chinacreator.gzcm.runtime.access.util.logging.plugin.LoggingPluginRegistry;
...
public class LoggingServiceImpl implements ILoggingService {
    ...
    private String getCallerClassName() {
        ...
        for (int i = 4; i < stackTrace.length; i++) {
            ...
            if (!className.startsWith("com.chinacreator.gzcm.runtime.access.util.logging")) {
                return className;
            }
        }
        return "unknown";
