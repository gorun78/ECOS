...
@Service
public class CognitiveEngineHealthService {

    private static final Logger log = LoggerFactory.getLogger(CognitiveEngineHealthService.class);

    private final JdbcTemplate jdbc;

    public CognitiveEngineHealthService(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
