...
import com.chinacreator.gzcm.engine.cognitive.CognitiveEngineImpl;
...
public class CognitiveEngineStatusController {

    private final CognitiveEngineImpl engine;

    public CognitiveEngineStatusController(CognitiveEngineImpl engine) {
        this.engine = engine;
    }
