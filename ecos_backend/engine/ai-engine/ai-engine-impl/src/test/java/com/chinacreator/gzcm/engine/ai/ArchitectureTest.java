...
/**
 * ArchitectureTest — ai-engine 架构约束（PMO-D1）
 *
 * <p>断言：
 * <ol>
 *   <li>所有类在 engine.ai 包下</li>
...
public class ArchitectureTest {
    ...
    static void setUp() {
        classes = new ClassFileImporter()
            .importPackages("com.chinacreator.gzcm.engine.ai");
    }
    ...
    void allPackagesShouldBeUnderEngine() {
        ArchRule rule = classes().that()
            .resideInAPackage("com.chinacreator.gzcm.engine.ai..")
    ...
    void serviceInterfacesShouldStartWithI() {
        ArchRule rule = classes().that()
            ...
            .orShould().haveSimpleNameStartingWith("LLM");      // LLMProvider legacy
    ...
    void controllersShouldBeInControllerPackage() {
        ArchRule rule = classes().that()
            ...
            .should().resideInAnyPackage("..controller..", "..oag..");  // OagController legacy
        rule.check(classes);
    }
    ...
    void shouldNotDependOnOtherEngines() {
        ArchRule rule = noClasses().that()
            .resideInAPackage("com.chinacreator.gzcm.engine.ai..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("com.chinacreator.gzcm.engine.data..", "com.chinacreator.gzcm.engine.ontology..", "com.chinacreator.gzcm.engine.kb..", "com.chinacreator.gzcm.engine.cognitive2..", "com.chinacreator.gzcm.engine.security..");
        rule.check(classes);
    }
}
