...
/**
 * ArchitectureTest — security-engine 架构约束（PMO-D1）
 *
 * <p>断言：
 * <ol>
 *   <li>所有类在 engine.security 包下</li>
...
public class ArchitectureTest {
    ...
    static void setUp() {
        classes = new ClassFileImporter()
            .importPackages("com.chinacreator.gzcm.engine.security");
    }
    ...
    void allPackagesShouldBeUnderEngine() {
        ArchRule rule = classes().that()
            .resideInAPackage("com.chinacreator.gzcm.engine.security..")
    ...
    void serviceInterfacesShouldStartWithI() {
        ArchRule rule = classes().that()
            ...
            .orShould().haveSimpleNameStartingWith("Mask");     // DataMaskingService$MaskFunction legacy
    ...
    void shouldNotDependOnOtherEngines() {
        ArchRule rule = noClasses().that()
            .resideInAPackage("com.chinacreator.gzcm.engine.security..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("com.chinacreator.gzcm.engine.data..", "com.chinacreator.gzcm.engine.ontology..", "com.chinacreator.gzcm.engine.kb..", "com.chinacreator.gzcm.engine.cognitive2..", "com.chinacreator.gzcm.engine.ai..");
        rule.check(classes);
    }
}
