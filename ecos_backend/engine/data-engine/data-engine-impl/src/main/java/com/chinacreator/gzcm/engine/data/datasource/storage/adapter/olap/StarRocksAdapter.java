package com.chinacreator.gzcm.engine.data.datasource.storage.adapter.olap;
...
/**
 * StarRocks存储适配器
 * StarRocks兼容MySQL协议，使用MySQL驱动
 * 
 * @author CDRC Runtime Team
 */
public class StarRocksAdapter extends BaseJdbcAdapter {
    ...
    protected String buildConnectionUrl(StorageConfig config) {
        ...
        if (config.getPort() != null) {
            ...
            url.append(":9030"); // StarRocks默认FE端口
        }
