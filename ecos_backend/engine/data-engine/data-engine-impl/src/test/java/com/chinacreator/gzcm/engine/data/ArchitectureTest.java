...
/**
 * ArchitectureTest — data-engine 架构约束（PMO-D1）
 *
 * <p>断言：
 * <ol>
 *   <li>所有类在 engine.data 包下</li>
...
public class ArchitectureTest {
    ...
    void controllersShouldBeInControllerPackage() {
        // 已知违规：PipelineController 在 pipeline 包而非 controller 包（历史遗留）
        // 白名单已加，修复另开指令
        ArchRule rule = classes().that()
            .areAnnotatedWith("org.springframework.web.bind.annotation.RestController")
            .should().resideInAnyPackage("..controller..", "..pipeline..");
        rule.check(classes);
    }
    ...
    void shouldNotDependOnOtherEngines() {
        ArchRule rule = noClasses().that()
            .resideInAPackage("com.chinacreator.gzcm.engine.data..")
            .should().dependOnClassesThat()
            .resideInAnyPackage("com.chinacreator.gzcm.engine.ontology..", "com.chinacreator.gzcm.engine.kb..", "com.chinacreator.gzcm.engine.cognitive2..", "com.chinacreator.gzcm.engine.ai..", "com.chinacreator.gzcm.engine.security..");
        rule.check(classes);
    }
}
