...
public class SearchOntologyGraphTool implements ToolExecutor {
    ...
    public SearchOntologyGraphTool(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    @Override
    public Object execute(String toolCode, Map<String, Object> params) {
        return restTemplate.getForObject("http://localhost:8080/api/v1/engine/ontology/graph/full", Object.class);
    }
